Feature: jiotune.setJiotune
  ...
  Scenario:Get vcode from jiotune.getHomepageData api
    ...
    Scenario Outline: Verify setJiotune api response
      ...
      When I make the "GET" request with the following query parameters for setJioTune and vcode being "<vcode>" msisdn being "RrXcJeH\/0WYXX7atH0ipSw==" and uid being "bharatkhati08"

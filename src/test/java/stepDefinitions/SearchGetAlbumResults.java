...
import validators.SearchGetAlbumResults.SearchGetAlbumResultsValidator;
...
public class SearchGetAlbumResults extends Util {
    ...
    public void search_get_album_results_response_must_be_validated_successfully() throws JsonProcessingException {
        ...
        pojos.SearchGetAlbumResults.SearchGetAlbumResults result = mapper.readValue(resp.asString(), pojos.SearchGetAlbumResults.SearchGetAlbumResults.class);
        SoftAssert sa = new SoftAssert();
        new SearchGetAlbumResultsValidator().validate(result, sa);
        sa.assertAll();
    }

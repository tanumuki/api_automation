...
public class SearchGetResults extends Util {
    ...
    @Given("Payload with endpoint search get results {string}")
    public void payload_with_endpoint_search_get_results(String endpoint) throws IOException {
    ...
    @When("User calls search get results api with the {string}")
    public void user_calls_search_get_results_api_with_the(String query) {
    ...
    @Then("search get results api must respond with status code {string}")
    public void search_get_results_api_must_respond_with_status_code(String statusCode) {

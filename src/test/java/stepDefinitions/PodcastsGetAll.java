...
public class PodcastsGetAll extends Util {
    ...
    @Given("Payload with podcasts get all endpoint {string}")
    public void payload_with_podcasts_get_all_endpoint(String endpoint) throws IOException {
    ...
    public void user_calls_podcasts_get_all_api() {
    ...
    @Then("Podcasts get all api should return with status code {string}")
    public void podcasts_get_all_api_should_return_with_status_code(String statusCode) {

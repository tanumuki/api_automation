...
public class UserPofileDataValidator {
    ...
    public void validateUserProfileInfo(UserGetProile userGetProile, SoftAssert sa) {
        String playlist_count = userGetProile.getPlaylist_count();
        ...
        String fbid = userGetProile.getFbid();
        ...
        String image_url = userGetProile.getImage_url();
        ...
        String phone_number = userGetProile.getPhone_number();
        ...
        String email = userGetProile.getEmail();
        ...
        String gender = userGetProile.getGender();
        ...
        String dob = userGetProile.getDob();
        ...
        String following_usersCount = userGetProile.getFollowing().getUsersCount();
        ...
        String following_artistsCount = userGetProile.getFollowing().getArtistsCount();
        ...
        String following_playlistsCount = userGetProile.getFollowing().getPlaylistsCount();
        ...
        String followedBy_usersCount = userGetProile.getFollowed_by().getUsersCount();
        ...
        String is_followed = userGetProile.getIs_followed();
        ...
        String playlists_id = userGetProile.getPlaylists().get(0).getId();
        ...
        String playlists_title = userGetProile.getPlaylists().get(0).getTitle();
        ...
        String playlists_subtitle = userGetProile.getPlaylists().get(0).getSubtitle();
        ...
        String playlists_type = userGetProile.getPlaylists().get(0).getType();
        ...
        String playlists_perma_url = userGetProile.getPlaylists().get(0).getPerma_url();
        ...
        String playlists_image = userGetProile.getPlaylists().get(0).getImage();
        ...
        String playlists_language = userGetProile.getPlaylists().get(0).getLanguage();
        ...
        String playlists_year = userGetProile.getPlaylists().get(0).getYear();
        ...
        String playlists_play_count = userGetProile.getPlaylists().get(0).getYear();
        ...
        String playlists_explicit_content = userGetProile.getPlaylists().get(0).getExplicit_content();
        ...
        String playlists_list_count = userGetProile.getPlaylists().get(0).getList_count();
        ...
        String playlists_list_type = userGetProile.getPlaylists().get(0).getList_type();
        ...
        String playlists_list = userGetProile.getPlaylists().get(0).getList();
        ...
        String playlists_moreinfo_username = userGetProile.getPlaylists().get(0).getMore_info().getUsername();
        ...
        String playlists_moreinfo_uid = userGetProile.getPlaylists().get(0).getMore_info().getUid();
        ...
        String playlists_moreinfo_contents = userGetProile.getPlaylists().get(0).getMore_info().getUid();
        sa.assertTrue(Validate.asString(playlists_moreinfo_uid), "validate uid in playlists more info failed");
        log.info("LOG response of uid in playlists more info in user get profile is " + playlists_moreinfo_uid);
    }
}

...
//            sa.assertTrue(Validate.asProStatusTierId(lp.getTier_id()), AssertionMsg.print(className, methodName, "user_state.prostatus.tier_id", lp.getTier_id()));
        ...
        if (lp.getPast_state() != null)
            sa.assertTrue(Validate.asPastState(lp.getPast_state()), AssertionMsg.print(className, methodName, "user_state.prostatus.past_state", lp.getPast_state()));
...
//            sa.assertTrue(Validate.asProStatusTierId(pd.getTier_id()), AssertionMsg.print(className, methodName, "user_state.prostatus.product_details.tier_id", pd.getTier_id()));
        ...
        if (Validate.isNonEmptyString(pd.getDiscount())){
            sa.assertTrue(Validate.asNum(pd.getDiscount()), AssertionMsg.print(className, methodName, "user_state.prostatus.product_details.discount", pd.getDiscount()));
        }
    }
}

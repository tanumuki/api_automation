...
//        image must be present. So no null checks
        ...
        if (moreInfo.getLabelUrl() != null){
            sa.assertTrue(Validate.asString(moreInfo.getLabelUrl()), AssertionMsg.print(className, methodName, "song.more_infor.label_url", moreInfo.getLabelUrl()));
        }
...
//            MultipleTunes multipleTunes = songObj.getMoreInfo().getMultiPleTunes();
    ...
    void validateMultipleTunes(MultipleTunes multipleTunes, SoftAssert sa) {
        final String methodName = new Throwable().getStackTrace()[0].getMethodName();

        sa.assertTrue(Validate.asString(multipleTunes.getId()), AssertionMsg.print(className, methodName,
                multipleTunes.getId(), "more_info.multiple_tunes.id", multipleTunes.getId(), multipleTunes.getId()));
        sa.assertTrue(Validate.asString(multipleTunes.getTitle()), AssertionMsg.print(className, methodName,
                multipleTunes.getTitle(), "more_info.multiple_tunes.getTitle", multipleTunes.getTitle(), multipleTunes.getTitle()));
        sa.assertTrue(Validate.asString(multipleTunes.getType()), AssertionMsg.print(className, methodName,
                multipleTunes.getType(), "more_info.multiple_tunes.getTitle", multipleTunes.getType(), multipleTunes.getType()));
        sa.assertTrue(Validate.asString(multipleTunes.getSubtype()), AssertionMsg.print(className, methodName,
                multipleTunes.getSubtype(), "more_info.multiple_tunes.getTitle", multipleTunes.getSubtype(), multipleTunes.getSubtype()));
        sa.assertTrue(Validate.asString(multipleTunes.getVcode()), AssertionMsg.print(className, methodName,
                multipleTunes.getVcode(), "more_info.multiple_tunes.getTitle", multipleTunes.getVcode(), multipleTunes.getVcode()));
        sa.assertTrue(Validate.asVlinkURL(multipleTunes.getVlink()), AssertionMsg.print(className, methodName,
                multipleTunes.getVlink(), "more_info.multiple_tunes.getTitle", multipleTunes.getVlink(), multipleTunes.getVlink()));
